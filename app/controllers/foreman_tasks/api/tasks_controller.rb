module ForemanTasks
  module Api
    class TasksController < ::Api::V2::BaseController
      ...
      def sub_tasks
        index
        render layout: 'api/v2/layouts/index_layout', action: 'index'
      end
      ...
      def index
        ...
        @tasks = DashboardTableFilter.new(resource_scope_for_index, params).scope.order("#{params[:order]}")
      end
      ...
      def resource_scope(_options = {})
        @resource_scope ||= begin
                              ...
                              scope = scope.where(:parent_task_id => params[:id]) if action_name == 'sub_tasks'
                              scope
                            end
      end
